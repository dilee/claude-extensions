...
This file is the canonical source of agent-facing rules. Tool-specific entry points (`CLAUDE.md`, etc.) point here so every agent — Claude Code, Codex, Gemini CLI, Cursor — works from the same directives.
